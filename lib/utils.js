...
module.exports = {
    ...
    editHelperPlist: function(plistInput, plistOutput, options) {
        options = options || {};
        ...
        return readFile(plistInput, 'utf8')
            ...
            // Then overwrite the properties with custom values
            .then(function(info) {
                info.CFBundleIdentifier = options.CFBundleIdentifier + '.helper';
                info.CFBundleName = options.CFBundleName + ' Helper';
                info.CFBundleDisplayName = options.CFBundleDisplayName + ' Helper';
                // Write output file
                return writeFile(plistOutput, plist.build(info));
            });
    }
